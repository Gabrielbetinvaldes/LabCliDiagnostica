...
class AgendaDisponible extends React.Component {
                        ...
                        <form className="user">
                            <div className="form-group row">
                                ...
                                <div className="col-sm-2 mb-3 mb-sm-0">
                                    <h6 className="m-2 font-weight-bold text-success">Consultar Agenda Disponible</h6>
                                </div>
                            ...
                            <table className="table " id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody className="table-light">
                                    <tr>
                                        ...
                                        <td>2021/11/30</td>
                                        <td>07:30 PM</td>
                                        <td><a href="#" className="text-decoration-underline">Seleccionar</a></td>
